...
class RecipeResourse extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'wallpaper' => Storage::url($this->wallpaper) ,
            'image_1' => Storage::url($this->image_1) ,
            'image_2' => Storage::url($this->image_2) ,
            'image_3' => Storage::url($this->image_3) ,
            'image_4' => Storage::url($this->image_4) ,
            'image_5' => Storage::url($this->image_5) ,
            'image_6' => Storage::url($this->image_6) ,
