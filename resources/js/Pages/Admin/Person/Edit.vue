<script setup>
    ...
    const form = useForm({
        ...
        instagram: props.person.instagram,
        facebook: props.person.facebook,
        linkedin: props.person.linkedin,
        phone: props.person.phone,
        cellphone: props.person.cellphone,
        info: props.person.info,
        web_site: props.person.web_site,
        specialty: props.person.specialty,
        photo: null,
    });
    ...
    const photoSrc = ref(props.person.photo)
    ...
    const submit = () => {
        form
            ...
            .post(route("admin.person.update", form.id), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    $q.notify({
    ...
    function destroy() {
        $q.dialog({
            ...
            Inertia.delete(route('admin.person.destroy', form.id), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
